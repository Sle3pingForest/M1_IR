...
def draw2(data):
    ...
    datas = [data_coin_340,data_coin_330,data_sombre_coin_340,data_04_04_2,data_04_04,data_nam_L,data_desordre]#data3, data_lumiere, data_lumiere2, data_sombre, data_sombre2]
    #showData(datas,True)
